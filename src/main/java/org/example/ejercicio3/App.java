...
public class App {
    ...
    public static void main(String[] args){
        ...
        evento1.crearActividad("Taller",6, "Entrega mochilas",50, false, "Pepito");
        evento1.crearActividad("Charla",6, "Entrega remeras",60, true, "Juancito");
        evento1.crearActividad("Charla",6, "Entrega pantalones",40, false, "Maximo");
        evento1.crearActividad("Taller",6, "Entrega bufandas",20, true, "Escobar");


        for (Estudiante estudiante:estudiantes){
            for(EventoUniversitario eventoUniversitario:eventos){
                for(Actividad actividad:eventoUniversitario.talleres){
                    actividad.inscribir(estudiante);

                }
                for(Actividad actividad:eventoUniversitario.charlas){
                    actividad.inscribir(estudiante);
